                    ...
                    <div class="heading__info">
                        <div class="info__icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                <g clip-path="url(#clip0_84950_4426)">
                                ...
                                <defs>
                                    <clipPath id="clip0_84950_4426">
                                        <rect width="14" height="14" fill="white" />
                                    </clipPath>
                                </defs>
                            </svg>
                        </div>
                        <div style={{color: "#4D4D4D"}} class="info__text">How it works</div>
                    </div>
                </div>
                    ...
                    <div class="search__box">
                        <div style={{
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                <g clip-path="url(#clip0_85506_4430)">
                ...
                <div class="header__actions">
                    ...
                    <div class="actions_dropdown">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <g clip-path="url(#clip0_84950_6209)">
