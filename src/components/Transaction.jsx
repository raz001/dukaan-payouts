...
const mockArr = [
    ...
    { date: 'Yesterday, 3:00 PM', status: "Successful", ID: '131634495747', amount: "₹10,125.00", fees: '₹1,125.00', total: '₹9,312' },
                ...
                <div class="table__header">
                    <div class="table__search">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <g clip-path="url(#clip0_84950_75719)">
